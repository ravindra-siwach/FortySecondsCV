...
\cvsection{Summary}
\aboutme{
    Experienced project manager with a proven track record in leading interdisciplinary teams of actuaries and data scientists. Passionate about data and committed to combining actuarial and data science best practices to automate repetitive tasks and empowering teams to generate meaningful and actionable insights from data. Effectively communicating with both technical as well as non-technical audience. Focused on maximizing value for stakeholders.}
...
\begin{cvtable}%[2]
    ...
    {Munich, Germany}
    {
        \begin{itemize}[nosep, leftmargin=12pt, label={-}] %
            ...
            \item Review and validate rates, reserves, financial projections and underwriting policies for M\&A actuarial due diligence.
