...
\aboutme{
        \begin{itemize}[nosep, leftmargin=0pt , label={-}] %
            ...
            \item Deep knowledge and experience across personal, commercial and specialty lines.
            \item Actuarial pricing and data science specialist.
...
\begin{cvtable}%[2]
    ...
    {Munich, Germany}
    {
        \begin{itemize}[nosep, leftmargin=12pt, label={-}] %
            ...
            \item Coordinate seamless data API integration for partners.
        \end{itemize}
    }
