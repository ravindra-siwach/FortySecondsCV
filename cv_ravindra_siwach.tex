...
% job title/career
\cvjobtitle{Actuary and Data Scientist}

%% optional information
% profile picture
\cvprofilepic{pics/profile_new.jpg}
% phone number
\cvphone{+65 9341 8575}
% email address
...
\addtofrontsidebar{
	...
	\profilesection{Technical Skills}
        ...
        \cvsubsection{Actuarial Analytics \& Software}
...
\aboutme{
    \begin{itemize}[nosep, leftmargin=0pt , label={-}] %
        ...
        \item Experience across personal, commercial and specialty lines with a deep knowledge of P\&C pricing and analytics.
