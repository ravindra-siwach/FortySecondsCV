...
\begin{cvtable}%[2]
    ...
    {Munich, Germany}
    {
        \begin{itemize}[nosep, leftmargin=12pt, label={-}] %
            \item Develop market prices, strategy and support product development in collaboration with Insurtechs\//MGAs for successful new products\//market launches.
            \item Diligent portfolio monitoring to maintain oversight and enhance profitability and market share.
