		...
		\cvitem
			...
			{Evalueserve (Gurgaon, India)}
			{
				...
				\begin{itemize}[nosep, leftmargin=0pt] % , label={-}
					...
					% \item Business development: contacting prospective clients to bring in new market research projects for the company.
				\end{itemize}
			}
		\cvitem
			{Oct 2004 -- Feb 2007}
			...
			{ 
				% \vspace{-\topsep}
				% \begin{itemize}[nosep, leftmargin=0pt] % , label={-}
				% 	\item Defining standard operating procedure for internal processes and mentoring new team members.
				% \end{itemize}
			}
	\end{cvtable}
